...
That folder is a pocket folder. It is NOT the project folder. The pocket folder contains meta files which are relevant only to the actual project folder. The actual project folder is
{{PROJECT_ROOT}}
